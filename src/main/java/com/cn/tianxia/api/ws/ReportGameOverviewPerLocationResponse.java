...
public class ReportGameOverviewPerLocationResponse  implements java.io.Serializable {
    private GameOverviewPerLocationRecord[] reportGameOverviewPerLocationResult;

    public ReportGameOverviewPerLocationResponse() {
    }

    public ReportGameOverviewPerLocationResponse(
           GameOverviewPerLocationRecord[] reportGameOverviewPerLocationResult) {
     ...
     */
    public GameOverviewPerLocationRecord[] getReportGameOverviewPerLocationResult() {
        return reportGameOverviewPerLocationResult;
    }
     ...
     */
    public void setReportGameOverviewPerLocationResult(GameOverviewPerLocationRecord[] reportGameOverviewPerLocationResult) {
        this.reportGameOverviewPerLocationResult = reportGameOverviewPerLocationResult;
    }
