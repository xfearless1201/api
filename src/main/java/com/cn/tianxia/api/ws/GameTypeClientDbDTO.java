...
public class GameTypeClientDbDTO  implements java.io.Serializable {
    ...
    private GameTranslationDTO[] translatedNames;
    ...
    public GameTypeClientDbDTO(
           ...
           GameTranslationDTO[] translatedNames) {
     ...
     */
    public GameTranslationDTO[] getTranslatedNames() {
        return translatedNames;
    }
     ...
     */
    public void setTranslatedNames(GameTranslationDTO[] translatedNames) {
        this.translatedNames = translatedNames;
    }
