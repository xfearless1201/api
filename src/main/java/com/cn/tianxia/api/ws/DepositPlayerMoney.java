...
public class DepositPlayerMoney  implements java.io.Serializable {
    private DepositPlayerMoneyRequest req;

    public DepositPlayerMoney() {
    }

    public DepositPlayerMoney(
           DepositPlayerMoneyRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public DepositPlayerMoneyRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(DepositPlayerMoneyRequest req) {
        this.req = req;
    }
