...
public class ReportGameOverviewPlayerResponse  implements java.io.Serializable {
    private PlayerGameOverviewRecord[] reportGameOverviewPlayerResult;

    public ReportGameOverviewPlayerResponse() {
    }

    public ReportGameOverviewPlayerResponse(
           PlayerGameOverviewRecord[] reportGameOverviewPlayerResult) {
     ...
     */
    public PlayerGameOverviewRecord[] getReportGameOverviewPlayerResult() {
        return reportGameOverviewPlayerResult;
    }
     ...
     */
    public void setReportGameOverviewPlayerResult(PlayerGameOverviewRecord[] reportGameOverviewPlayerResult) {
        this.reportGameOverviewPlayerResult = reportGameOverviewPlayerResult;
    }
