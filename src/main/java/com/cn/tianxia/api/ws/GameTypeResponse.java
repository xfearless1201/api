...
public class GameTypeResponse  extends BaseResponse  implements java.io.Serializable {
    private GameTypeClientDbDTO[] gameTypes;

    public GameTypeResponse() {
    }

    public GameTypeResponse(
           GameTypeClientDbDTO[] gameTypes) {
     ...
     * @return gameTypes
     */
    public GameTypeClientDbDTO[] getGameTypes() {
        return gameTypes;
    }
     ...
     * @param gameTypes
     */
    public void setGameTypes(GameTypeClientDbDTO[] gameTypes) {
        this.gameTypes = gameTypes;
    }
