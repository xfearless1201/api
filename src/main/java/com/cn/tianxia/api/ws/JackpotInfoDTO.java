...
public class JackpotInfoDTO  implements java.io.Serializable {
    ...
    private JackpotValueDTO[] conversions;
     ...
     * @return conversions
     */
    public JackpotValueDTO[] getConversions() {
        return conversions;
    }
     ...
     * @param conversions
     */
    public void setConversions(JackpotValueDTO[] conversions) {
        this.conversions = conversions;
    }
