...
public class ReportGameOverviewBrandResponse  implements java.io.Serializable {
    private GameOverviewRecord[] reportGameOverviewBrandResult;

    public ReportGameOverviewBrandResponse() {
    }

    public ReportGameOverviewBrandResponse(
           GameOverviewRecord[] reportGameOverviewBrandResult) {
     ...
     */
    public GameOverviewRecord[] getReportGameOverviewBrandResult() {
        return reportGameOverviewBrandResult;
    }
     ...
     */
    public void setReportGameOverviewBrandResult(GameOverviewRecord[] reportGameOverviewBrandResult) {
        this.reportGameOverviewBrandResult = reportGameOverviewBrandResult;
    }
