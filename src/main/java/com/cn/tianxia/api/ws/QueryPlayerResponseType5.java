...
public class QueryPlayerResponseType5  implements java.io.Serializable {
    private QueryPlayerResponse queryPlayerResult;

    public QueryPlayerResponseType5() {
    }

    public QueryPlayerResponseType5(
           QueryPlayerResponse queryPlayerResult) {
     ...
     */
    public QueryPlayerResponse getQueryPlayerResult() {
        return queryPlayerResult;
    }
     ...
     */
    public void setQueryPlayerResult(QueryPlayerResponse queryPlayerResult) {
        this.queryPlayerResult = queryPlayerResult;
    }
