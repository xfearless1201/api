...
public class LogoutThirdPartyPlayerResponse  implements java.io.Serializable {
    private ThirdPartyPlayerLogoutResponse logoutThirdPartyPlayerResult;

    public LogoutThirdPartyPlayerResponse() {
    }

    public LogoutThirdPartyPlayerResponse(
           ThirdPartyPlayerLogoutResponse logoutThirdPartyPlayerResult) {
     ...
     */
    public ThirdPartyPlayerLogoutResponse getLogoutThirdPartyPlayerResult() {
        return logoutThirdPartyPlayerResult;
    }
     ...
     */
    public void setLogoutThirdPartyPlayerResult(ThirdPartyPlayerLogoutResponse logoutThirdPartyPlayerResult) {
        this.logoutThirdPartyPlayerResult = logoutThirdPartyPlayerResult;
    }
