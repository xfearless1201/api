...
public class GameDisplayResponse  extends BaseResponse  implements java.io.Serializable {
     ...
     * @param gameDisplay
     */
    public void setGameDisplay(Game[][] gameDisplay) {
        this.gameDisplay = gameDisplay;
    }
