...
public class LogoutAllPlayersInBrand  implements java.io.Serializable {
    private LogoutAllPlayersInBrandRequest req;

    public LogoutAllPlayersInBrand() {
    }

    public LogoutAllPlayersInBrand(
           LogoutAllPlayersInBrandRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public LogoutAllPlayersInBrandRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(LogoutAllPlayersInBrandRequest req) {
        this.req = req;
    }
