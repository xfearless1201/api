...
public class CouponInfoDTO  implements java.io.Serializable {
    ...
    private ComplexDepositCouponInfo[] complexConfig;
    ...
    public CouponInfoDTO(
           ...
           ComplexDepositCouponInfo[] complexConfig,
     ...
     */
    public ComplexDepositCouponInfo[] getComplexConfig() {
        return complexConfig;
    }
     ...
     * @param complexConfig
     */
    public void setComplexConfig(ComplexDepositCouponInfo[] complexConfig) {
        this.complexConfig = complexConfig;
    }
