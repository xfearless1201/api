...
public class SetMaintenanceModeResponse  implements java.io.Serializable {
    private MaintenanceModeResponse setMaintenanceModeResult;

    public SetMaintenanceModeResponse() {
    }

    public SetMaintenanceModeResponse(
           MaintenanceModeResponse setMaintenanceModeResult) {
     ...
     */
    public MaintenanceModeResponse getSetMaintenanceModeResult() {
        return setMaintenanceModeResult;
    }
     ...
     */
    public void setSetMaintenanceModeResult(MaintenanceModeResponse setMaintenanceModeResult) {
        this.setMaintenanceModeResult = setMaintenanceModeResult;
    }
