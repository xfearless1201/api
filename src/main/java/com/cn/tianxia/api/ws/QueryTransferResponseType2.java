...
public class QueryTransferResponseType2  implements java.io.Serializable {
    private QueryTransferResponse queryTransferResult;

    public QueryTransferResponseType2() {
    }

    public QueryTransferResponseType2(
           QueryTransferResponse queryTransferResult) {
     ...
     */
    public QueryTransferResponse getQueryTransferResult() {
        return queryTransferResult;
    }
     ...
     */
    public void setQueryTransferResult(QueryTransferResponse queryTransferResult) {
        this.queryTransferResult = queryTransferResult;
    }
