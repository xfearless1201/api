...
public class LoginOrCreatePlayer  implements java.io.Serializable {
    private LoginOrCreatePlayerRequest req;

    public LoginOrCreatePlayer() {
    }

    public LoginOrCreatePlayer(
           LoginOrCreatePlayerRequest req) {
           this.req = req;
    }
     ...
     * @return req
     */
    public LoginOrCreatePlayerRequest getReq() {
        return req;
    }
     ...
     * @param req
     */
    public void setReq(LoginOrCreatePlayerRequest req) {
        this.req = req;
    }
