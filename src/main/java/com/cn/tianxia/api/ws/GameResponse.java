...
public class GameResponse  extends BaseResponse  implements java.io.Serializable {
    private java.lang.String hostedLaunchUrl;

    private GameClientDbDTO[] games;
     ...
     * @return games
     */
    public GameClientDbDTO[] getGames() {
        return games;
    }
     ...
     * @param games
     */
    public void setGames(GameClientDbDTO[] games) {
        this.games = games;
    }
