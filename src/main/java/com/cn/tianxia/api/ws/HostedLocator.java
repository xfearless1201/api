...
public class HostedLocator extends org.apache.axis.client.Service implements Hosted {
    ...
    public HostedSoap getHostedSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            HostedSoapStub _stub = new HostedSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (HostedSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                HostedSoapStub _stub = new HostedSoapStub(new java.net.URL(HostedSoap_address), this);
                _stub.setPortName(getHostedSoapWSDDServiceName());
                return _stub;
            }
        }
