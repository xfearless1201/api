...
import com.cn.tianxia.api.utils.jczf.Base64;

/**
 * @Auther: zed
 * @Date: 2019/2/17 13:41
 * @Description: 捷付支付加密工具类
 * @since 1.8
 */
public class JEERSAUtils {
    ...
    public static String encryptByPublicKey(String content, String publicKey) throws Exception {
        ...
        return Base64.getEncoder().encodeToString(encryptByPublicKey(content.getBytes(StandardCharsets.UTF_8), publicKey));
    }
    //2.1 2.3
