...
public class JSONUtils {
     ...
     * @return
     */
    public static boolean compare(JSONObject jsonObject, String value, String compareValue) {
        if(jsonObject.containsKey(value)&&compareValue.equals(jsonObject.getString(value))) {
            return true;
        }
        return false;
    }
