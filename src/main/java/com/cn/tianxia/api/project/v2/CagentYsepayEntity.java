...
public class CagentYsepayEntity implements Serializable {
    ...
    private Double ysfMinquota;

    private Double ysfMaxquota;
    ...
    public Double getYsfMinquota() {
        return ysfMinquota;
    }
    
    public void setYsfMinquota(Double ysfMinquota) {
        this.ysfMinquota = ysfMinquota;
    }
    
    public Double getYsfMaxquota() {
        return ysfMaxquota;
    }
    
    public void setYsfMaxquota(Double ysfMaxquota) {
        this.ysfMaxquota = ysfMaxquota;
    }
}